define(["require", "exports", "../wafle"], function(require, exports, Wafle) {
    var InventoryTypeAttributes = (function () {
        function InventoryTypeAttributes(p1, p2) {
            this.isActive = false;
            this.name = '';
            this.techLevel = 1;
            this.description = '';
            ...
            var data = Wafle.TypeInfo.GetTypeAttributes(this.typeId, this.groupId);
            if (!data) {
        ...
        InventoryTypeAttributes.prototype.totalAlphaDamageActual = function (ship, charge) {
            var total = 0;
        ...
        InventoryTypeAttributes.prototype.Activate = function () {
            this.isActive = true;
        };
        InventoryTypeAttributes.prototype.Deactivate = function () {
            this.isActive = false;
        };

        InventoryTypeAttributes.prototype.typeInfo = function () {
            return new Wafle.TypeInfo(this.typeId, this.groupId);
        };

        InventoryTypeAttributes.prototype.damageMultiplierForModule = function (theAttackingModule) {
...
//# sourceMappingURL=InventoryTypeAttributes.js.map
